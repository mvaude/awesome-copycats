...
client.connect_signal("manage", function (c)
    ...
    -- Open programs to active/selected screen in Awesome WM: https://stackoverflow.com/questions/12648254/open-programs-to-active-selected-screen-in-awesome-wm
